...
DEFAULT_SOURCES = [
    ...
    # --- Boards found by pointing discovery at 179 government organisations,
    # targeted using the e-GP spending record for who actually buys cyber work.
    # Each URL below was verified to survive redirects and to carry a dated
    # notice list; `rows_seen` is what discovery counted at the time.
    {
        "name": "กอ.รมน. — ประกาศจัดซื้อจัดจ้าง",
        "source_type": "GOVERNMENT",
        "url": "https://www.isoc.go.th/procure.php",
        "is_active": True,
        "config_json": json.dumps({
            "is_official_source": True,
            "agency_name": "กองอำนวยการรักษาความมั่นคงภายในราชอาณาจักร",
            "max_pages": 3,
            "discover_sitemaps": False,
            "item_selector": "ul li",
            "request_delay_seconds": 0.4,
            "verified_note": "e-GP บันทึกว่า กอ.รมน. จัดซื้องานไซเบอร์ 65 รายการใน 1 ปี สูงเป็นอันดับ 3 ของประเทศ; discovery พบรายการลงวันที่ 51 แถว",
        }, ensure_ascii=False),
    },
    {
        "name": "กรมศุลกากร — ประกาศจัดซื้อจัดจ้าง",
        "source_type": "GOVERNMENT",
        "url": "https://www.customs.go.th/list_strc_download_date.php?show_search=1&ini_content=procurement_161115_01&ini_menu=menu_public_relations_160421_01&lang=th&left_menu=menu_public_relations_160421_01_161115_01",
        "is_active": True,
        "config_json": json.dumps({
            "is_official_source": True,
            "agency_name": "กรมศุลกากร",
            "max_pages": 3,
            "discover_sitemaps": False,
            "item_selector": "table tbody tr",
            "request_delay_seconds": 0.4,
            "verified_note": "discovery พบตารางประกาศลงวันที่ 72 แถว; e-GP บันทึกการจัดซื้อไซเบอร์ 7 รายการใน 1 ปี รวมประกวดราคา e-bidding เมื่อ 24 ก.ค. 69",
        }, ensure_ascii=False),
    },
    {
        "name": "มหาวิทยาลัยสุโขทัยธรรมาธิราช — ประกาศจัดซื้อจัดจ้าง",
        "source_type": "GOVERNMENT",
        "url": "https://www.stou.ac.th/website/Tender2/home.aspx?idindex=1",
        "is_active": True,
        "config_json": json.dumps({
            "is_official_source": True,
            "agency_name": "มหาวิทยาลัยสุโขทัยธรรมาธิราช",
            "max_pages": 2,
            "discover_sitemaps": False,
            "item_selector": "table tr",
            "request_delay_seconds": 0.4,
            "verified_note": "discovery พบตารางประกาศลงวันที่ 78 แถว มากที่สุดในกลุ่มสถาบันการศึกษาที่ตรวจ",
        }, ensure_ascii=False),
    },
    {
        "name": "สำนักงานปลัดกระทรวงศึกษาธิการ — ประกาศจัดซื้อจัดจ้าง",
        "source_type": "GOVERNMENT",
        "url": "https://www.moe.go.th/category/procurement-news/",
        "is_active": False,
        "last_status": "DISABLED_SELECTOR_MISMATCH",
        "config_json": json.dumps({
            "is_official_source": True,
            "agency_name": "สำนักงานปลัดกระทรวงศึกษาธิการ",
            "max_pages": 3,
            "discover_sitemaps": False,
            "item_selector": "article",
            "request_delay_seconds": 0.4,
            "disabled_reason": "discovery เห็นรายการลงวันที่ 18 แถวจาก selector 'article' แต่ตัวดึงจริงอ่านได้ 0 รายการ แปลว่าโครงสร้างหน้าต่างจากที่ probe ต้องหา selector ที่ถูกก่อนเปิดใช้",
            "verified_note": "discovery พบรายการลงวันที่ 18 แถว; สถานศึกษาเป็นผู้ซื้อไซเบอร์ 125 รายการใน 1 ปีตามข้อมูล e-GP",
        }, ensure_ascii=False),
    },
    {
        "name": "การประปานครหลวง (กปน.) — ประกาศประกวดราคา",
        "source_type": "STATE_ENTERPRISE",
        "url": "https://www.mwa.co.th/movement/procurement-announcing/tender-announcement/",
        "is_active": True,
        "config_json": json.dumps({
            "is_official_source": True,
            "agency_name": "การประปานครหลวง",
            "max_pages": 3,
            "discover_sitemaps": False,
            "item_selector": "li.post",
            "request_delay_seconds": 0.4,
            "verified_note": "discovery พบรายการประกวดราคาลงวันที่ 14 แถว",
        }, ensure_ascii=False),
    },
    {
        "name": "สำนักงานเศรษฐกิจอุตสาหกรรม — ประกาศจัดซื้อจัดจ้าง",
        "source_type": "GOVERNMENT",
        "url": "https://www.oie.go.th/view/1/%E0%B9%81%E0%B8%9C%E0%B8%99%E0%B8%9B%E0%B8%8F%E0%B8%B4%E0%B8%9A%E0%B8%B1%E0%B8%95%E0%B8%B4%E0%B8%81%E0%B8%B2%E0%B8%A3%E0%B8%88%E0%B8%B1%E0%B8%94%E0%B8%8B%E0%B8%B7%E0%B9%89%E0%B8%AD%E0%B8%88%E0%B8%B1%E0%B8%94%E0%B8%88%E0%B9%89%E0%B8%B2%E0%B8%87/TH-TH",
        "is_active": True,
        "config_json": json.dumps({
            "is_official_source": True,
            "agency_name": "สำนักงานเศรษฐกิจอุตสาหกรรม",
            "max_pages": 2,
            "discover_sitemaps": False,
            "item_selector": "ul li",
            "request_delay_seconds": 0.4,
            "verified_note": "discovery พบรายการลงวันที่ 28 แถว",
        }, ensure_ascii=False),
    },
    {
        "name": "สำนักงานปรมาณูเพื่อสันติ — ประกาศจัดซื้อจัดจ้าง",
        "source_type": "GOVERNMENT",
        "url": "https://www.oap.go.th/pr-news/announcement/procurement/tender/",
        "is_active": True,
        "config_json": json.dumps({
            "is_official_source": True,
            "agency_name": "สำนักงานปรมาณูเพื่อสันติ",
            "max_pages": 2,
            "discover_sitemaps": False,
            "item_selector": "article",
            "request_delay_seconds": 0.4,
            "verified_note": "discovery พบรายการประกวดราคาลงวันที่ 11 แถว",
        }, ensure_ascii=False),
    },
    {
        "name": "กรมป่าไม้ — ประกาศจัดซื้อจัดจ้าง",
        "source_type": "GOVERNMENT",
        "url": "https://www.forest.go.th/blog/category/monthly-procurement/",
        "is_active": True,
        "config_json": json.dumps({
            "is_official_source": True,
            "agency_name": "กรมป่าไม้",
            "max_pages": 2,
            "discover_sitemaps": False,
            "item_selector": "article",
            "request_delay_seconds": 0.4,
            "verified_note": "discovery พบรายการลงวันที่ 10 แถว",
        }, ensure_ascii=False),
    },
    {
        "name": "ไปรษณีย์ไทย — ประกาศจัดซื้อจัดจ้าง",
        "source_type": "STATE_ENTERPRISE",
        "url": "https://www.thailandpost.co.th/un/purchase_file_list/article/446",
        "is_active": False,
        "last_status": "DISABLED_SELECTOR_MISMATCH",
        "config_json": json.dumps({
            "is_official_source": True,
            "agency_name": "บริษัท ไปรษณีย์ไทย จำกัด",
            "max_pages": 2,
            "discover_sitemaps": False,
            "item_selector": "table tbody tr",
            "request_delay_seconds": 0.4,
            "disabled_reason": "discovery เห็นตาราง 4 แถว แต่ตัวดึงจริงอ่านได้ 0 รายการ ต้องตรวจว่าตารางมาจาก JavaScript หรือ selector ไม่ตรงก่อนเปิดใช้",
            "verified_note": "discovery พบตารางประกาศลงวันที่ 4 แถว",
        }, ensure_ascii=False),
    },
    {
        "name": "กรมวิทยาศาสตร์การแพทย์ — ประกาศจัดซื้อจัดจ้าง",
        "source_type": "GOVERNMENT",
        "url": "https://www.dmsc.moph.go.th/th/downloadAll/pus",
        "is_active": True,
        "config_json": json.dumps({
            "is_official_source": True,
            "agency_name": "กรมวิทยาศาสตร์การแพทย์",
            "max_pages": 2,
            "discover_sitemaps": False,
            "item_selector": ".item",
            "request_delay_seconds": 0.4,
            "verified_note": "discovery พบรายการลงวันที่ 4 แถว; สถานพยาบาลเป็นผู้ซื้อไซเบอร์ 316 รายการใน 1 ปีตามข้อมูล e-GP",
        }, ensure_ascii=False),
    },
    {
        "name": "กรมทางหลวง — ประกาศจัดซื้อจัดจ้าง",
        "source_type": "GOVERNMENT",
        "url": "https://www.doh.go.th/procurement",
        "is_active": True,
        "config_json": json.dumps({
            "is_official_source": True,
            "agency_name": "กรมทางหลวง",
            "max_pages": 3,
            "discover_sitemaps": False,
            "item_selector": "table tbody tr",
            "request_delay_seconds": 0.4,
            "verified_note": "ตารางประกาศ 15 แถว/หน้า ลงประกาศเชิญชวนใหม่แทบทุกวัน (ตรวจเมื่อ 5 ก.ย. 69 พบประกาศลงวันที่ 3-4 ก.ย.)",
        }, ensure_ascii=False),
    },
    {
        "name": "สำนักงานอัยการสูงสุด — ประกาศจัดซื้อจัดจ้าง",
        "source_type": "GOVERNMENT",
        "url": "https://www.ago.go.th/procurement/",
        "is_active": True,
        "config_json": json.dumps({
            "is_official_source": True,
            "agency_name": "สำนักงานอัยการสูงสุด",
            "max_pages": 3,
            "discover_sitemaps": False,
            "item_selector": "table tbody tr",
            "request_delay_seconds": 0.4,
            "verified_note": "ตารางรวมประกาศของอัยการทั่วประเทศ 1,098 แถว ในจำนวนนี้เป็นประกาศเชิญชวน 163 รายการ",
        }, ensure_ascii=False),
    },
    {
        "name": "กระทรวงดิจิทัลเพื่อเศรษฐกิจและสังคม (MDES)",
        "source_type": "GOVERNMENT",
        "url": "https://mdes.go.th/procurement",
        "is_active": True,
        "config_json": json.dumps({
            "is_official_source": True,
            "agency_name": "กระทรวงดิจิทัลเพื่อเศรษฐกิจและสังคม",
            "max_pages": 3,
            "discover_sitemaps": False,
            "item_selector": "ul li",
            "request_delay_seconds": 0.4,
            "verified_note": "รายการประกาศแบบ list 149 แถว เป็นกระทรวงที่ซื้องานไอที/ไซเบอร์โดยตรง",
        }, ensure_ascii=False),
    },
    {
        "name": "สถาบันเทคโนโลยีพระจอมเกล้าเจ้าคุณทหารลาดกระบัง",
        "source_type": "GOVERNMENT",
        "url": "https://www.kmitl.ac.th/procurement",
        "is_active": True,
        "config_json": json.dumps({
            "is_official_source": True,
            "agency_name": "สถาบันเทคโนโลยีพระจอมเกล้าเจ้าคุณทหารลาดกระบัง",
            "max_pages": 3,
            "discover_sitemaps": False,
            "item_selector": "table tbody tr",
            "request_delay_seconds": 0.4,
            "verified_note": "ตารางประกาศ 20 แถว เป็นประกาศเชิญชวน 7 รายการ",
        }, ensure_ascii=False),
    },
    {
        "name": "การรถไฟฟ้าขนส่งมวลชนแห่งประเทศไทย (รฟม.)",
        "source_type": "STATE_ENTERPRISE",
        "url": "https://www.mrta.co.th/procurement",
        "is_active": True,
        "config_json": json.dumps({
            "is_official_source": True,
            "agency_name": "การรถไฟฟ้าขนส่งมวลชนแห่งประเทศไทย",
            "max_pages": 3,
            "discover_sitemaps": False,
            "item_selector": "table tbody tr",
            "request_delay_seconds": 0.4,
            "verified_note": "ตารางประกาศจัดซื้อจัดจ้าง ตรวจแล้วมีแถวที่มีวันที่จริง 4 แถว",
        }, ensure_ascii=False),
    },
    {
        "name": "กรมบังคับคดี — ประกาศจัดซื้อจัดจ้าง",
        "source_type": "GOVERNMENT",
        "url": "https://www.led.go.th/purchase/preview5.asp",
        "is_active": True,
        "config_json": json.dumps({
            "is_official_source": True,
            "agency_name": "กรมบังคับคดี",
            "max_pages": 3,
            "discover_sitemaps": False,
            "item_selector": "table tbody tr",
            "request_delay_seconds": 0.4,
            "verified_note": "ตารางประกาศ ตรวจแล้วมีแถวที่มีวันที่จริง 12 แถว",
        }, ensure_ascii=False),
    },
    {
