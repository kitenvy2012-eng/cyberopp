...
**กลุ่ม A — ต้องค้นหาและตรวจช่องทางเอกชนเพิ่ม**
AIS, True, KBANK, SCB, BBL, TTB, CP All, Central Retail, WHA, Bitkub, BDMS

แก้ไขข้อสรุปเดิม: การลอง URL บางเส้นทางแล้วไม่พบ ไม่ได้พิสูจน์ว่าบริษัทไม่มีประกาศสาธารณะ ตรวจพบ [บอร์ดจัดซื้อ SCB](https://www.scb.co.th/th/about-us/news/auction-bidding.html) และ [ช่องทาง Procurement AIS](https://aisprocurement.cloud.ais.th/en) แล้ว โดย SCB มีลิงก์เอกสารสาธารณะ แต่วัน “ยื่นแบบ” ไม่ใช่วันเผยแพร่ ส่วน AIS เป็นช่องทางคู่ค้า ไม่ใช่ฟีด RFP สาธารณะ ทั้งสองกรณีไม่ใช่หลักฐานว่ามีงานไซเบอร์ที่ยังยื่นได้

**กลุ่ม B — แหล่งภาครัฐ/รัฐวิสาหกิจที่ต้องตรวจวันและเงื่อนไขรายประกาศเช่นกัน**
NT, KTB, PTT, MEA — มีช่องทางจัดซื้อที่ควรตรวจสอบ แต่ไม่ใช้เพื่ออ้างว่าครอบคลุมเอกชนเพิ่ม และไม่รับประกันว่ารายการที่พบยังเปิดรับ
